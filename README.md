...
- Contador de Palabras:
  Crear un algoritmo que permita realizar el conteo de
...
_Nombre del script: word_counter.py
_Nombre del archivo de texto: phrases.txt
  
- Palíndromos: 
  Crear un algoritmo que permita identificar si una palabra ingresada
...
_Nombre del script: palindromes.py
  
- Fibonacci: 
  Crear un algoritmo que permita ingresar un número entero, y muestre en
...
_Nombre del script: fibonacci.py
  
- Generador de Contraseñas: 
  Crear un algoritmo que permita generar una
...
_Nombre del script: password_generator.py
  
- Libreta de Direcciones: 
  Crear un algoritmo que permita registrar información de
...
registro).
_Nombre del script: address_book.py
_Nombre del archivo de texto: addresses.csv
